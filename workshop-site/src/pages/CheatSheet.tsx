      ...
      <section>
        ...
        <div className="rounded-xl overflow-hidden border border-slate-700/50">
          ...
          {[
            ...
            { concept: 'Design tokens', sfra: 'SCSS variables', sfnext: 'CSS variables (src/theme/tokens/)' },
            ...
            { concept: 'API layer', sfra: 'Pipeline → API', sfnext: 'SCAPI helper (lib/api/*.server.ts)' },
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          {[
            ...
            { file: 'src/theme/tokens/brand.css', purpose: 'Brand design tokens — colors, light/dark mode' },
            { file: 'src/theme/tailwind.css', purpose: '@theme bridge — maps CSS vars to Tailwind utilities' },
            { file: 'src/lib/api/', purpose: 'SCAPI wrapper functions (.server.ts) with TypeScript types' },
