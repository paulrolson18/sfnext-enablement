...
const moduleStepCounts: Record<string, string[]> = {
  ...
  '/setup': ['setup-bm-login', 'setup-admin', 'setup-import-export', 'setup-upload', 'setup-import', 'setup-import-done', 'setup-storefronts', 'setup-add-new', 'setup-configure', 'setup-complete'],
